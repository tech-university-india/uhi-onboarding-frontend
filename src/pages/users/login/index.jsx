...
const LOGIN_TYPE = {
  OTP_VIA_AADHAR: 'AADHAAR_OTP',
  OTP_VIA_MOBILE: 'MOBILE_OTP'
}
              ...
              <>
                {currentLoginType ===
                  ...
                  <CustomInput
                    ...
                    onChange={handleAbhaNumberOnChange}
                    disabled={otpSent}
                  ></CustomInput>
                )}
                {currentLoginType ===
          ...
          {otpSent && currentLoginType && (
            <>
              {currentLoginType === LOGIN_TYPE.OTP_VIA_AADHAR && (
                <LoginFormButtons
                  onValidateOTPClick={
                    getVerifyLoginHandlerFor[
                      LOGIN_TYPE.OTP_VIA_AADHAR
                    ]
                  }
                  onResendOTPClick={
                    getResendOTPHandlerFor[
                      LOGIN_TYPE.OTP_VIA_AADHAR
                    ]
                  }
                />
